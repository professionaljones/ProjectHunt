...
void AHuntPlayerCharacter::SetPlayerStats(float NewMaxHealth, float NewMaxAragon, TEnumAsByte<EPlayerSuit> NewPlayerSuit, TEnumAsByte<ESuitMainAbilities> NewSuitPower, TEnumAsByte<ESuitPowerModifiers> NewPowerModifierOne, TEnumAsByte<ESuitPowerModifiers> NewPowerModifierTwo, int32 NewMaxMissileCount, bool bCanPlayerUseMissiles, bool bCanPlayerDash, bool bCanPlayerWallrun, bool bCanPlayerUseAragon, TMap<int32, AHuntWeapon*> NewWeaponInventory, int32 NewCurrentDataPoints)
{
	...
	//UnlockAbility(PlayerSavedStats.bHasMissileLauncher, bCanPlayerUseMissiles);
	PlayerSavedStats.bHasMissileLauncher = bCanPlayerUseMissiles;
	PlayerSavedStats.bUnlockedAragon = bCanPlayerUseAragon;
